...
//		System.out.println(res[1]);
	...
	@Override
	public Key keygen(Key publicKey, Key masterKey, Attribute[] attributes) {
...
//		System.out.println(ciphertext);
	...
	@Override
	public byte[] decrypt(Ciphertext ciphertext, Key publicKey, Key secretKey) {
	...
	public static void main(String[] args) {
		...
		Ciphertext ciphertext = scheme.encrypt(keys[0], policy, null,
				symmetricKey);

		byte[] res = scheme.decrypt(ciphertext, keys[0], sk);
	}
